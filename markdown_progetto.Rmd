...
\hspace{1em} 4.1 Global exploratory analyses & X \\
\hspace{1em} 4.2 Variables transformation & X \\
\hspace{1em} 4.3 Plotting function and division in groups & X \\
\hspace{1em} 4.4 Analysis on groups of variables & X \\
...
\hspace{1em} 4.1 Initial data preparation for Modeling & X \\
\hspace{1em} 4.2 Functions definition & X \\
\hspace{1em} 4.3 Obtaining Models & X \\
